...
var Dajaxice = {
    ...
    sayhello: function(callback_function, argv, custom_settings){
        return Dajaxice.call('djangoodle.sayhello', 'POST', callback_function, argv, custom_settings);
    },

    add_participant: function(callback_function, argv, custom_settings){
        return Dajaxice.call('djangoodle.add_participant', 'POST', callback_function, argv, custom_settings);
    }
